...
<!-- First Child -->
  ...
  <nav class="navbar navbar-expand-sm sticky-top second-nav" style= "background-color:#c39797;">
    <ul class="navbar-nav me-auto">      
      ...
      if(!isset($_SESSION['username'])){
        echo "<li class='nav-item'>
        <a class='nav-link text-strong' style='color: #0e1111' href='#'>Welcome Guest</a>
      </li>";
      }else{
        echo "<li class='nav-item'>
        <a class='nav-link text-strong text-light' style='color: #0e1111' href='#'>Welcome ".$_SESSION['username']."</a>
      </li>";
      }
      if(!isset($_SESSION['username'])){
        echo "<li class='nav-item'>
